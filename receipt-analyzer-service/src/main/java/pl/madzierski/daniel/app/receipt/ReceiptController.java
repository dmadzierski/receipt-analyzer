...
public class ReceiptController {
    ...
    public ResponseEntity<CreateReceiptResponse> addReceipt(@RequestPart(value = "file") MultipartFile file, @RequestPart(value = "body", required = false) CreateReceiptRequest body) {
